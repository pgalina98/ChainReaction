...
interface ToastProps {
  type: ToastType;
  message: string;
  positionX?: "left-5" | "right-5";
  positionY?: "top-5" | "bottom-5";
  isShown: boolean;
  hideToast: any;
}

const renderSuccessToast = (message: string, onCloseToastButtonClick: any) => {
  return (
    <React.Fragment>
...
const renderDangerToast = (message: string, onCloseToastButtonClick: any) => {
  return (
    <React.Fragment>
...
const renderWarningToast = (message: string, onCloseToastButtonClick: any) => {
  return (
    <React.Fragment>
...
const Toast = ({
  ...
  return (
    <motion.div
      ...
      role="alert"
    >
      {type === ToastType.SUCCESS && renderSuccessToast(message, onCloseToastButtonClick)}
      {type === ToastType.DANGER && renderDangerToast(message, onCloseToastButtonClick)}
      {type === ToastType.WARNING && renderWarningToast(message, onCloseToastButtonClick)}
    </motion.div>
  );
};
