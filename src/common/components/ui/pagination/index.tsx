  ...
  return (
    ...
    >
      <span className="text-sm text-white dark:text-white-400">
        Showing{" "}
        <span className="font-semibold text-white dark:text-white">1</span> to{" "}
        <span className="font-semibold text-white dark:text-white">10</span> of{" "}
        <span className="font-semibold text-white dark:text-white">100</span>{" "}
        Entries
      </span>
