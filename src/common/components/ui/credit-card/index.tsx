      ...
      >
        ...
        >
          <div className="front">
            ...
            <div className="credit_card_type">MasterCard</div>
            <div className="chip">
            ...
            <div className="end">
              ...
              <span className="end-date ml-2">{expirationDate || "mm/yy"}</span>
            </div>
            <div className="cardholder z-10">mr {cardholder || "John Doe"}</div>
